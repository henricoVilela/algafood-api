package com.study.algafood.api.v1;
...
import com.study.algafood.api.v1.controller.FluxoPedidoController;
import com.study.algafood.api.v1.controller.FormaPagamentoController;
import com.study.algafood.api.v1.controller.GrupoController;
import com.study.algafood.api.v1.controller.GrupoPermissaoController;
import com.study.algafood.api.v1.controller.PedidoController;
import com.study.algafood.api.v1.controller.RestauranteController;
import com.study.algafood.api.v1.controller.RestauranteFormaPagamentoController;
import com.study.algafood.api.v1.controller.RestauranteProdutoController;
import com.study.algafood.api.v1.controller.RestauranteProdutoFotoController;
import com.study.algafood.api.v1.controller.RestauranteUsuarioResponsavelController;
import com.study.algafood.api.v1.controller.UsuarioController;
import com.study.algafood.api.v1.controller.UsuarioGrupoController;
...
public class CreatorLinks {
	...
	public Link linkToPedidos() {
		...
		Link link = Link.of(UriTemplate.of(pedidosUrl, PAGINACAO_VARIABLES.concat(filtroVariables)), "pedidos");
	...
	public Link linkToPedidos(String rel) {
		...
		String pedidosUrl = linkTo(PedidoController.class).toUri().toString();
		Link link = Link.of(UriTemplate.of(pedidosUrl, PAGINACAO_VARIABLES.concat(filtroVariables)), rel);
